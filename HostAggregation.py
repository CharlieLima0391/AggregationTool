...
# Load and file and extract hostname column
...
xdr_df = pd.read_csv(r'C:\Users\cdominguez\python\aggregationtool\Working\sourceData\endpoint_agents_page_2024-10-31T10_56_43.csv', low_memory=False)
